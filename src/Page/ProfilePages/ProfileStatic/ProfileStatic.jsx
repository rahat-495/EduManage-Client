    ...
    return (
        <div className="flex flex-col items-center justify-center gap-3">
            ...
            <div className="flex flex-col items-center justify-center gap-3 mt-5">
                <h1 className="gro text-xl lg:text-3xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-[#00FFB2] text-center">Discover new possibilities through <br /> additional educational and technical-related <br /> information !</h1>
